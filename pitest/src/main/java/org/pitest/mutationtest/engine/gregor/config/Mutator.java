...
public enum Mutator implements Iterable<MethodMutatorFactory> {
  ...
  RMSWITCH(
   ...
   SDL(RETURN_VALS,VOID_METHOD_CALLS,NON_VOID_METHOD_CALLS,CONSTRUCTOR_CALLS,EXPERIMENTAL_MEMBER_VARIABLE,REMOVE_INCREMENTS,REMOVE_CONDITIONALS,DELETE_CONDITIONALS,RMSWITCH),
  /**
   * All the mutators
   */
  ALL(DEFAULTS, NON_VOID_METHOD_CALLS, CONSTRUCTOR_CALLS, INLINE_CONSTS,REMOVE_INCREMENTS,
