...
public class LimitNumberOfMutationPerLineFilter implements MutationFilter {

  private final int maxMutationsPerLine;

  public LimitNumberOfMutationPerLineFilter(final int max) {
    this.maxMutationsPerLine = max;
  }
  ...
  private Collection<MutationDetails> choose(
	  ...
	  int max = Math.min(mutations.size(), maxMutationsPerLine);
